...
/**
 * Whether a package is resolvable: profile node_modules, the shared
 * profiles/node_modules fallback, and — for link-installed plugins — the
 * plugin directory's own node_modules (Node resolves the link target's
 * imports from its real path).
 */
