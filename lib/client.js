								...
								return react.createElement("div", { key: key, style: s.pluginCard },
									...
									picking
										? react.createElement("div", { style: Object.assign({}, s.row, { background: "var(--dsw-alias-bg-layer-2)", border: "1px solid var(--dsw-alias-border-l1)", borderRadius: 8, padding: "8px 10px" }) },
											...
											react.createElement("button", { type: "button", style: s.btn, onClick: function () { setModePicker(""); install(cand, "link"); }, disabled: !!busy }, "link（改源码重启即生效）"),
											react.createElement("button", { type: "button", style: s.btn, onClick: function () { setModePicker(""); install(cand, "copy"); }, disabled: !!busy }, "copy（独立副本，改源码需重装）"),
