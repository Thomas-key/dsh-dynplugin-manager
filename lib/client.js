		...
		function DynPluginManager() {
			...
			return react.createElement("div", { style: s.wrap },
				...
				react.createElement("p", { style: s.hint },
					"扫描指定目录下每个第一层子文件夹，含有 package.json 且声明了 dsh.dynamic.host 的才是插件。此页只读浏览；加载请在会话中使用斜杠命令 /dynload <插件名>。"),
				...
				state.loading ? react.createElement("p", { style: s.empty }, "加载中…") :
					(state.plugins.length === 0 ? react.createElement("p", { style: s.empty }, "暂无插件（确认目录下有含 package.json + dsh.dynamic.host 的子文件夹）") :
