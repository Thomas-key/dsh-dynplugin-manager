					...
					candidates.length > 0
						? react.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 10 } },
							candidates.map(function (cand, i) {
								...
								var canInstall = cand.status === "ready";
								...
								return react.createElement("div", { key: key, style: s.pluginCard },
									react.createElement("div", { style: s.row },
										...
										react.createElement("button", {
											type: "button",
											style: Object.assign({}, s.btnPrimary, canInstall ? {} : s.btnDisabled),
											onClick: startInstall,
											disabled: !!busy || !canInstall,
											title: canInstall ? "" : (cand.status === "needs-deps" ? "需先在 package.json 声明依赖：" + (cand.imports || []).join(", ") : "入口文件缺失，请先构建"),
										},
											busy === key ? "安装中…" : (isRunner ? "安装到托管目录" : (isNpm ? "安装" : "安装（选方式）")))
									),
